...
require github.com/streamnative/streamnative-sql-go v0.0.0-00010101000000-000000000000
...
replace github.com/xo/dburl => ./dburl

replace github.com/streamnative/streamnative-sql-go => ./streamnative-sql-go
